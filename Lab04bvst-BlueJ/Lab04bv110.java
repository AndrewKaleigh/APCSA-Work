...
public class Lab04bv110 extends Applet
{
    ...
    public void paint(Graphics g)
    {
        ...
        g.drawArc(150,75,25,225,90,180); // arcs going left
        g.drawArc(125,75,75,225,90,180);
        g.drawArc(100,75,125,225,90,180);
        g.drawArc(75,75,175,225,90,180);
        g.drawArc(50,175,225,25,0,-180); // arcs going down
        g.drawArc(50,150,225,75,0,-180);
        g.drawArc(50,125,225,125,0,-180);
        g.drawArc(50,100,225,175,0,-180);
        g.drawArc(150,75,25,225,90,-180); // arcs going right
        g.drawArc(125,75,75,225,90,-180);
        g.drawArc(100,75,125,225,90,-180);
        g.drawArc(75,75,175,225,90,-180);
