...
public class ElevensBoard {
    ...
    private boolean containsJQK(List<Integer> selectedCards) {
        ...
        if (cards[selectedCards.get(0)].pointValue() + cards[selectedCards.get(1)].pointValue() + cards[selectedCards.get(2)].pointValue() == 0){
            if (cards[selectedCards.get(0)].rank() != cards[selectedCards.get(1)].rank() && cards[selectedCards.get(1)].rank() != cards[selectedCards.get(2)].rank() && cards[selectedCards.get(2)].rank() != cards[selectedCards.get(0)].rank()){
                return true;
            }
        }
        return false;
